...
enum RealtimeClientFactory {
    static func makeClient(modelPreference: RealtimeModelPreference = .realtimeMini) -> RealtimeSessionClient {
        ...
        #else
        return OpenAIRealtimeWebRTCClient(modelPreference: modelPreference)
        #endif
    }
}
