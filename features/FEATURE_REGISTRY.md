...
| Teacher pedagogy (engaging & talkative) | `features/session/session.feature` | `ios/App/LanguageSpeakingTrainer/LanguageSpeakingTrainer/SafetySystemPrompt.swift` | In progress | Prompt now encourages short turns, A/B choices, sentence starters, gentle recasts, and light retrieval practice; verify end-to-end behavior. |
